...
namespace DesktopAutomation.Tests.Screens
{
    ...
    {
        public Button BoldButton => new(By.XPath("//Group/Group/Group[2]/Group/Group[3]/Window/Group[2]/Group[1]/Group/Group/Custom/Group/Group/Group/Group/Group[3]/Group/Group[2]/Group[1]"), "Кнопка 'Полужирный'", WebDriver);
        public Button UnderLiningButton => new(By.XPath("//Group/Group/Group[2]/Group/Group[3]/Window/Group[2]/Group[1]/Group/Group/Custom/Group/Group/Group/Group/Group[3]/Group/Group[2]/Group[3]"), "Кнопка 'Подчёркивание'", WebDriver);
        public Button LineSpacing => new(By.XPath("//Group/Group/Group[2]/Group/Group[3]/Window/Group[2]/Group[1]/Group/Group/Custom/Group/Group/Group/Group/Group[5]/Group/Group[3]/Group[9]"), "Кнопка 'Междустрочный интервал'", WebDriver);
        ...
        private int MoreLiningSpacingX = 1050;
        private int MoreLiningSpacingY = 380;
